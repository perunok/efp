...
@section('content')
    <div class="container w-3/5 mx-auto bg-white dark:bg-gray-800 p-8">
        ...
        <div class="container w-3/4 mx-auto">
            ...
            <div
                class="max-w-full h-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    <h3 class="mb-2 font-bold tracking-tight text-gray-900 dark:text-white">Posted
                        {{ substr($broadcast->created_at, 0, 10) }} At {{ substr($broadcast->created_at, 10) }}</h3>
                    <h3 class="mb-2 font-bold tracking-tight text-gray-900 dark:text-white">Tags : {{ $broadcast->tags }}</h3>
